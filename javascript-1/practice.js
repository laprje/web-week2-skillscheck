...
const lovesCodeChecker = (x) => {if (x === true){
	return true;
} else return false;
}
...
const oddChecker = (num) => {if (num % 2 === 0) {
...
// let middleNums = numbers.filter(function(el, i, arr) {
...
notGeorge.forEach(function(el, i, arr) {
